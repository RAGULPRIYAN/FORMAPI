...
// })
// Call the toggleButton function to display the update button
// toggleButton(true);

// Call the toggleButton function to display the submit button
// toggleButton(false);
        ...
        html += `<tr>
            ...
            <td>
                ...
                <td>
                  ...
                  <a onclick="edituser(${e.id})">  <i class="bi bi-pencil-square"></i></a>
